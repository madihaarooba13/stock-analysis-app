...
export default function Footer() {
  ...
  return (
    <footer className="mt-24 border-t border-white/10 bg-[#020617] text-white">
      ...
      <div className="max-w-6xl mx-auto px-6 py-14 grid md:grid-cols-3 gap-12">
        ...
        <div>
          ...
          <div className="flex gap-3 mt-6">
            ...
            <a
              ...
              target="_blank"
              className="group p-3 rounded-xl bg-white/5 border border-white/10 hover:border-white/20 hover:bg-white/10 transition"
            >
              <svg
        ...
        {/* 🔥 MIDDLE - LINKS */}
        <div>
          <p className="text-sm font-medium mb-3 text-white">Explore</p>
        ...
        {/* 🔥 RIGHT - STATUS CARD */}
        <div>
          <p className="text-sm font-medium mb-3 text-white">Market Status</p>
